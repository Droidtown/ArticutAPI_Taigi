...
if __name__ == "__main__":
    ...
    inputLIST = [
        ...
        "伊真𠢕軁鑽，隨揣著頭路",
        "地動了後，彼間樓仔厝敢若有淡薄仔歪斜",
        "來啊！燒淨香，點束柴，敲鐘擂鼓，迎接侍候",
        "人咧做，天咧看",
        "誠歹勢，我無拄好煞共恁的玻璃杯仔摃破去",
        "我遮爾仔信任你，你煞來共我欺騙，實在予人料想袂到",
        "為著一屑仔錢佇街仔路搝搝搦搦，敢會看口得？",
        "伊毋敢直接看，干焦用目尾偷䀐",
        "彼間新開的海產店，麥仔酒予你啉迵海的",
        "仙拚仙，害死猴齊天",
        "這个是內孫，毋是外孫",
        "人生茫茫渺渺，毋知影對佗位來，嘛毋知影對佗位去",
        "這壁堵的敆逝若無創好勢，後擺是會漏水",
        "一丈差九尺，差遠咧",
        "遮的蓮霧攏是頭篩仔，寄予行口賣，價數一定誠好",
        "今仔日親情族孫攏來矣，阿媽足歡喜的",
        "伊規日勼踮厝內，袂輸涵空龜咧，時勢啥款攏毋知",
        "伊的人較土直，毋才較會去得失人",
        "你送遮爾大的禮，我受當袂起",
        "閣過去就是別人的地界矣，咱行到遮就好",
        "咱是親情，煞為著金錢拍歹感情",
        ...
        "老人面皮抾襇，會挾死胡蠅",
        "趁人冤家相拍，伊也倚去抾肉幼仔鬥拍",
        "囡仔疕爾爾就生毛閣發角，我看你是皮咧癢的款",
        "這个所在誠狹，真歹轉踅，你轉踅的時陣著細膩",
        "十九，水倒拗",
        "伊跋落去山跤閣無死，真正是萬幸！",
        "這馬景氣真䆀，逐家攏強欲無頭路矣",
        "我初初佮伊熟似的時，伊拄高中出業",
