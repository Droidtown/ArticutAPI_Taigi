...
shiftRule =[
    ...
    (re.compile("<ENTITY_pronoun>[彼這逐]</ENTITY_pronoun><ENTITY_noun>[篇片爿條支枝隻幅本尾口盆台囷組塊匹坩間粒味雙个蕊件個坵甌副項層部帖軀碗盤包箱籃齣句胎陣門橛目子]</ENTITY_noun>"), ("</ENTITY_pronoun><ENTITY_noun>", "ENTITY_pronoun", "ENTITY_noun"), ("", "ENTITY_DetPhrase", "ENTITY_DetPhrase")),
    ...
    (re.compile("<ENTITY_num>[^<]+</ENTITY_num><ENTITY_classifier>[^<]仔?</ENTITY_classifier>"), ("</ENTITY_num><ENTITY_classifier>", "ENTITY_num"), ("", "ENTITY_classifier")),
    ...
    (re.compile("<ENTITY_num>[^<]+</ENTITY_num><ENTITY_classifier>逝</ENTITY_classifier>"), ("</ENTITY_num><ENTITY_classifier>", "ENTITY_num", "ENTITY_classifier"), ("", "ACTION_eventQuantifier", "ACTION_eventQuantifier")),
    ...
    (re.compile("<ACTION_verb>[^<有予共配]</ACTION_verb><ENTITY_noun>[^<人囝錢輩]</ENTITY_noun>"), ("</ACTION_verb><ENTITY_noun>", "ENTITY_noun"), ("", "ACTION_verb")),
    ...
    (re.compile("<ACTION_verb>[^<想要著欲愛學去來會講用贏通]</ACTION_verb><ACTION_verb>[^<較予光欲有愛]</ACTION_verb>(?!<ACTION_verb>著)(?!<FUNC_negation>袂)"), ("</ACTION_verb><ACTION_verb>",), ("",)),
