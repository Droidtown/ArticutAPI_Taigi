...
shiftRule =[
    ...
    (re.compile("<ACTION_verb>予</ACTION_verb>((?=<ENTITY_pronoun>[^<]</ENTITY_pronoun><ACTION_verb>)|(?=<ENTITY_possessive>))"), ("verb",), ("lightVerb",)),
    ...
    (re.compile("<ACTION_verb>共</ACTION_verb>((?=<ENTITY_pronoun>)|(?=<ACTION_verb>)|(?=<ENTITY_pronoun>)|(?=<ENTITY_DetPhrase>)|(?=<ENTITY_noun>人))"), ("verb",), ("lightVerb",)),
