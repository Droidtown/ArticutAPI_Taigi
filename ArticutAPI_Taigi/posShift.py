...
shiftRule =[
    ...
    (re.compile("<ENTITY_pronoun>[彼這]</ENTITY_pronoun><ENTITY_noun>[片條支枝隻本尾口塊坩間粒味雙个蕊件個坵甌副項層部帖軀碗盤包箱籃齣句胎]</ENTITY_noun>"), ("</ENTITY_pronoun><ENTITY_noun>", "ENTITY_pronoun", "ENTITY_noun"), ("", "ENTITY_DetPhrase", "ENTITY_DetPhrase")),
    ...
    (re.compile("<ACTION_verb>足</ACTION_verb>(?=<ACTION_verb>)"), ("ACTION_verb",), ("FUNC_degreeHead",)),
    ...
    (re.compile("<ENTITY_num>[^<]+</ENTITY_num><ENTITY_noun>[片條支枝隻本尾口塊坩間粒味雙个蕊件個坵甌副項層部帖軀碗盤包箱籃齣句胎]</ENTITY_noun>"), ("</ENTITY_num><ENTITY_noun>", "ENTITY_num", "ENTITY_noun"), ("", "ENTITY_classifier", "ENTITY_classifier")),
    (re.compile("<MODIFIER>半</MODIFIER><ENTITY_noun>[片條支枝隻本尾口塊坩間粒味雙个蕊件個坵甌副項層部帖軀碗盤包箱籃齣句胎]</ENTITY_noun>"), ("</MODIFIER><ENTITY_noun>", "MODIFIER", "ENTITY_noun"), ("", "ENTITY_classifier", "ENTITY_classifier")),
    ...
    (re.compile("(<ENTITY_num>[一二三四五六七八九十百千萬億兆]+</ENTITY_num><ACTION_verb>箍</ACTION_verb>)"), ("</ENTITY_num><ACTION_verb>", "ENTITY_num", "ACTION_verb"), ("", "ENTITY_currency", "ENTITY_currency")),
    ...
    (re.compile("<MODIFIER>規[^<]</MODIFIER>"), ("MODIFIER",), ("QUANTIFIER",)),
    # </CLAUSE/MODIFIER => QUANTIFIER>
    ...
    (re.compile("<ACTION_verb>[^<想要欲愛去來會]</ACTION_verb><ACTION_verb>[^<]</ACTION_verb>(?!<ACTION_verb>著)"), ("</ACTION_verb><ACTION_verb>",), ("",)),
    # </N => V>
