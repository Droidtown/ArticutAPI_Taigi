...
shiftRule =[
    ...
    # <N => V>
    (re.compile("<ACTION_verb>[^<有予]</ACTION_verb><ENTITY_oov>[^<]</ENTITY_oov>"), ("</ACTION_verb><ENTITY_oov>", "ENTITY_oov"), ("", "ACTION_verb")),
    (re.compile("<ACTION_verb>[^<有予]</ACTION_verb><ENTITY_noun>[^<人]</ENTITY_noun>"), ("</ACTION_verb><ENTITY_noun>", "ENTITY_noun"), ("", "ACTION_verb")),
    ...
    (re.compile("<ACTION_verb>[^<想要欲愛去來會]</ACTION_verb><ACTION_verb>[^<較予光]</ACTION_verb>(?!<ACTION_verb>著)(?!<FUNC_negation>袂)"), ("</ACTION_verb><ACTION_verb>",), ("",)),
