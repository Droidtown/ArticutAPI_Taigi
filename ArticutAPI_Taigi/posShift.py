...
shiftRule =[
    ...
    (re.compile("<ENTITY_classifier>[^<]</ENTITY_classifier><ENTITY_classifier>[^<才]</ENTITY_classifier>"), ("</ENTITY_classifier><ENTITY_classifier>",), ("",)),
    ...
    (re.compile("<ENTITY_pronoun>[彼這逐]</ENTITY_pronoun><ENTITY_noun>[筆篇片爿條支枝隻幅本尾口盆台囷組塊匹坩間粒味雙个蕊件個坵甌副項層部帖軀碗盤包箱籃齣句胎陣門橛目子段欉]</ENTITY_noun>"), ("</ENTITY_pronoun><ENTITY_noun>", "ENTITY_pronoun", "ENTITY_noun"), ("", "ENTITY_DetPhrase", "ENTITY_DetPhrase")),
    ...
    (re.compile("<ACTION_verb>[^<]人</ACTION_verb>"), ("人</ACTION_verb>",), ("</ACTION_verb><ENTITY_noun>人</ENTITY_noun>",)),
