...
shiftRule =[
    ...
    (re.compile("<ENTITY_pronoun>[彼這]</ENTITY_pronoun><ENTITY_noun>[片條支隻本尾口塊坩間粒味雙个蕊件個坵甌副項]</ENTITY_noun>"), ("</ENTITY_pronoun><ENTITY_noun>", "ENTITY_pronoun", "ENTITY_noun"), ("", "ENTITY_DetPhrase", "ENTITY_DetPhrase")),
    ...
    (re.compile("<ENTITY_num>[^<]+</ENTITY_num><ENTITY_noun>[片條支隻本尾口塊坩間粒味雙个蕊件個坵甌副項]</ENTITY_noun>"), ("</ENTITY_num><ENTITY_noun>", "ENTITY_num", "ENTITY_noun"), ("", "ENTITY_classifier", "ENTITY_classifier")),
    (re.compile("<MODIFIER>半</MODIFIER><ENTITY_noun>[片條支隻本尾口塊坩間粒味雙个蕊件個坵甌副項]</ENTITY_noun>"), ("</MODIFIER><ENTITY_noun>", "MODIFIER", "ENTITY_noun"), ("", "ENTITY_classifier", "ENTITY_classifier")),
    ...
    (re.compile("<ACTION_verb>[^<]</ACTION_verb><ENTITY_noun>[^<人]</ENTITY_noun>"), ("</ACTION_verb><ENTITY_noun>", "ENTITY_noun"), ("", "ACTION_verb")),
