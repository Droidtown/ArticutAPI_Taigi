...
shiftRule =[
    ...
    (re.compile("<ACTION_verb>做頭</ACTION_verb><ENTITY_noun>人</ENTITY_noun>"), ("<ACTION_verb>做頭</ACTION_verb><ENTITY_noun>人</ENTITY_noun>",), ("<ACTION_verb>做</ACTION_verb><ENTITY_noun>頭人</ENTITY_noun>",)),
    ...
    (re.compile("<ENTITY_pronoun>[彼這逐恁]</ENTITY_pronoun><ENTITY_noun>[筆篇箍片爿條支枝隻幅本尾口盆台囷組班塊匹坩間粒味雙个蕊件個坵甌副項層部帖軀碗盤包箱籃齣句胎陣門橛目子段欉桌]</ENTITY_noun>"), ("</ENTITY_pronoun><ENTITY_noun>", "ENTITY_pronoun", "ENTITY_noun"), ("", "ENTITY_DetPhrase", "ENTITY_DetPhrase")),
    ...
    (re.compile("<ENTITY_num>[^<]+</ENTITY_num><ENTITY_classifier>[^<逝擺]仔?</ENTITY_classifier>"), ("</ENTITY_num><ENTITY_classifier>", "ENTITY_num"), ("", "ENTITY_classifier")),
    ...
    (re.compile("<ENTITY_num>[^<]+</ENTITY_num><ENTITY_classifier>[逝擺]</ENTITY_classifier>"), ("</ENTITY_num><ENTITY_classifier>", "ENTITY_num", "ENTITY_classifier"), ("", "ACTION_eventQuantifier", "ACTION_eventQuantifier")),
    ...
    (re.compile("<ENTITY_classifier>[^<]+箍</ENTITY_classifier>"), ("ENTITY_classifier",), ("ENTITY_currency",)),
    ...
    (re.compile("<ACTION_verb>[^<有予共配去]</ACTION_verb><ENTITY_noun>[^<人囝錢輩]</ENTITY_noun>"), ("</ACTION_verb><ENTITY_noun>", "ENTITY_noun"), ("", "ACTION_verb")),
    ...
    (re.compile("<ACTION_verb>[^<想要著欲愛學去來會講用贏通予]</ACTION_verb><ACTION_verb>[^<較予光欲有愛會]</ACTION_verb>(?!<ACTION_verb>[著去])(?!<FUNC_negation>袂)"), ("</ACTION_verb><ACTION_verb>",), ("",)),
    ...
    (re.compile("<ACTION_verb>[^<欲]+</ACTION_verb><ACTION_verb>起</ACTION_verb>"), ("</ACTION_verb><ACTION_verb>",), ("",)),
    ...
    (re.compile("<ENTITY_noun>人頭</ENTITY_noun><ENTITY_classifier>[^<]+</ENTITY_classifier>"), ("<ENTITY_noun>人頭</ENTITY_noun>", "<ENTITY_classifier>", "ENTITY_classifier"), ("<ENTITY_noun>人</ENTITY_noun><ENTITY_DetPhrase>頭", "", "ENTITY_DetPhrase")),
