...
shiftRule =[
    ...
    (re.compile("<ENTITY_classifier>[^<筆]</ENTITY_classifier><ENTITY_classifier>[^<才]</ENTITY_classifier>"), ("</ENTITY_classifier><ENTITY_classifier>",), ("",)),
    ...
    (re.compile("<ENTITY_pronoun>[彼這逐恁]</ENTITY_pronoun><ENTITY_noun>[筆篇片爿條支枝隻幅本尾口盆台囷組塊匹坩間粒味雙个蕊件個坵甌副項層部帖軀碗盤包箱籃齣句胎陣門橛目子段欉]</ENTITY_noun>"), ("</ENTITY_pronoun><ENTITY_noun>", "ENTITY_pronoun", "ENTITY_noun"), ("", "ENTITY_DetPhrase", "ENTITY_DetPhrase")),
    ...
    (re.compile("<ENTITY_oov>[^<]</ENTITY_oov><ENTITY_noun>車</ENTITY_noun>"), ("</ENTITY_oov><ENTITY_noun>", "ENTITY_oov"), ("", "ENTITY_noun")),
    (re.compile("<ENTITY_noun>[^<]+</ENTITY_noun><ENTITY_noun>位</ENTITY_noun>"), ("</ENTITY_noun><ENTITY_noun>",), ("",)),
    # <N => V>
    (re.compile("(?<=</ACTION_verb>)<ACTION_verb>予</ACTION_verb>(?=<MODIFIER>)"), ("ACTION_verb",), ("FUNC_inner",)),
    (re.compile("<ACTION_verb>[^<有予共配]</ACTION_verb><ENTITY_oov>[^<囝錢]</ENTITY_oov>"), ("</ACTION_verb><ENTITY_oov>", "ENTITY_oov"), ("", "ACTION_verb")),
    ...
    (re.compile("<ACTION_verb>[^<想要著欲愛學去來會講用贏通予]</ACTION_verb><ACTION_verb>[^<較予光欲有愛]</ACTION_verb>(?!<ACTION_verb>著)(?!<FUNC_negation>袂)"), ("</ACTION_verb><ACTION_verb>",), ("",)),
    ...
    (re.compile("(?<=</ACTION_verb>)<TIME_justtime>過去</TIME_justtime>$"), ("TIME_justtime",), ("ACTION_verb",)),
