...
shiftRule =[
    ...
    (re.compile("<ENTITY_pronoun>遮</ENTITY_pronoun><ACTION_verb>撇</ACTION_verb>"), ("<ENTITY_pronoun>遮</ENTITY_pronoun><ACTION_verb>撇</ACTION_verb>",), ("<DegreeP>遮撇</DegreeP>",)),
    ...
    (re.compile("<ACTION_verb>[^<想要欲愛學去來會]</ACTION_verb><ACTION_verb>[^<較予光欲]</ACTION_verb>(?!<ACTION_verb>著)(?!<FUNC_negation>袂)"), ("</ACTION_verb><ACTION_verb>",), ("",)),
