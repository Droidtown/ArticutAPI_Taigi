...
shiftRule =[
    ...
    (re.compile("<ACTION_verb>[^<想要著欲愛學去來會講用贏通予]</ACTION_verb><ACTION_verb>[^<較予光欲有愛會]</ACTION_verb>(?!<ACTION_verb>著)(?!<FUNC_negation>袂)"), ("</ACTION_verb><ACTION_verb>",), ("",)),
    ...
    (re.compile("<ACTION_verb>[^<]+</ACTION_verb><ACTION_verb>起</ACTION_verb>"), ("</ACTION_verb><ACTION_verb>",), ("",)),
