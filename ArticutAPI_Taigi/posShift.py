...
shiftRule =[
    ...
    (re.compile("<FUNC_conjunction>莫怪</FUNC_conjunction>"), ("<FUNC_conjunction>莫怪</FUNC_conjunction>",), ("<ACTION_verb>莫怪</ACTION_verb>",)),
    ...
    (re.compile("<ACTION_verb>規</ACTION_verb>(?=<ENTITY_classifier>)"), ("ACTION_verb",), ("QUANTIFIER",)),
    ...
    (re.compile("<ENTITY_pronoun>[彼這]</ENTITY_pronoun><ACTION_verb>張</ACTION_verb>"), ("</ENTITY_pronoun><ACTION_verb>", "pronoun", "ACTION_verb"), ("", "DetPhrase", "ENTITY_DetPhrase")),
    ...
    (re.compile("<ENTITY_pronoun>[彼這]</ENTITY_pronoun><ENTITY_noun>[片爿條支枝隻本尾口盤台組塊匹坩間粒味雙个蕊件個坵甌副項層部帖軀碗盤包箱籃齣句胎陣門橛目子]</ENTITY_noun>"), ("</ENTITY_pronoun><ENTITY_noun>", "ENTITY_pronoun", "ENTITY_noun"), ("", "ENTITY_DetPhrase", "ENTITY_DetPhrase")),
    (re.compile("<ENTITY_pronoun>[彼這]</ENTITY_pronoun><ACTION_verb>[種盤領把]</ACTION_verb>"), ("</ENTITY_pronoun><ACTION_verb>", "ENTITY_pronoun", "ACTION_verb"), ("", "ENTITY_DetPhrase", "ENTITY_DetPhrase")),
    (re.compile("<ENTITY_pronoun>[彼這]</ENTITY_pronoun><ACTION_verb>出</ACTION_verb>(?=<ENTITY_noun>菜)"), ("</ENTITY_pronoun><ACTION_verb>", "ENTITY_pronoun", "ACTION_verb"), ("", "ENTITY_DetPhrase", "ENTITY_DetPhrase")),
    ...
    # </NN => N>
    (re.compile("((?<=<ACTION_verb>[^<]</ACTION_verb>)|(?<=</MODIFIER>))<ACTION_verb>甲</ACTION_verb>"), ("ACTION_verb",), ("FUNC_inner",)),
    ...
    (re.compile("<ENTITY_num>[^<]+</ENTITY_num><ACTION_verb>[種排盤把]</ACTION_verb>"), ("</ENTITY_num><ACTION_verb>", "ENTITY_num", "ACTION_verb"), ("", "ENTITY_classifier", "ENTITY_classifier")),
    (re.compile("<ENTITY_num>[^<]+</ENTITY_num><ENTITY_noun>[片爿條支枝隻本尾口盤台組塊匹坩間粒味雙个蕊件個坵甌副項層部帖軀碗盤包箱籃齣句胎陣門橛目子]</ENTITY_noun>"), ("</ENTITY_num><ENTITY_noun>", "ENTITY_num", "ENTITY_noun"), ("", "ENTITY_classifier", "ENTITY_classifier")),
    (re.compile("<MODIFIER>半</MODIFIER><ENTITY_noun>[片爿條支枝隻本尾口盤台組塊匹坩間粒味雙个蕊件個坵甌副項層部帖軀碗盤包箱籃齣句胎陣門橛目子]</ENTITY_noun>"), ("</MODIFIER><ENTITY_noun>", "MODIFIER", "ENTITY_noun"), ("", "ENTITY_classifier", "ENTITY_classifier")),
    ...
    (re.compile("<ENTITY_pronoun>這</ENTITY_pronoun><ENTITY_noun>[改場回]</ENTITY_noun>"), ("</ENTITY_pronoun><ENTITY_noun>", "ENTITY_pronoun", "ENTITY_noun"), ("", "ACTION_eventQuantifier", "ACTION_eventQuantifier")),
    ...
    (re.compile("((?<=</FUNC_inner>)|(?<=</ACTION_verb>))<FUNC_conjunction>閣</FUNC_conjunction>"), ("FUNC_conjunction",), ("MODIFIER",)),
    ...
    # <N => V>
    (re.compile("<ACTION_verb>[^<有]</ACTION_verb><ENTITY_oov>[^<]</ENTITY_oov>"), ("</ACTION_verb><ENTITY_oov>", "ENTITY_oov"), ("", "ACTION_verb")),
    (re.compile("<ACTION_verb>[^<有]</ACTION_verb><ENTITY_noun>[^<人]</ENTITY_noun>"), ("</ACTION_verb><ENTITY_noun>", "ENTITY_noun"), ("", "ACTION_verb")),
    (re.compile("<ACTION_verb>[^<有]</ACTION_verb><ENTITY_nouny>[^<]</ENTITY_nouny>"), ("</ACTION_verb><ENTITY_nouny>", "ENTITY_nouny"), ("", "ACTION_verb")),
    (re.compile("<ACTION_verb>[^<有]</ACTION_verb><ENTITY_nounHead>[^<]</ENTITY_nounHead>"), ("</ACTION_verb><ENTITY_nounHead>", "ENTITY_nounHead"), ("", "ACTION_verb")),
    (re.compile("(?<=<ACTION_verb>[^<]{2}</ACTION_verb>)<ENTITY_noun>戶</ENTITY_noun>"), ("noun",), ("nounHead",)),
    (re.compile("<ACTION_verb>[^<想要欲愛去來會]</ACTION_verb><ACTION_verb>[^<較予]</ACTION_verb>(?!<ACTION_verb>著)(?!<FUNC_negation>袂)"), ("</ACTION_verb><ACTION_verb>",), ("",)),
    ...
    (re.compile("<ENTITY_noun>閣</ENTITY_noun>(?=<ACTION_verb>)"), ("ENTITY_noun",), ("MODIFIER",)),
    (re.compile("<ENTITY_pronoun>遮</ENTITY_pronoun>(?=<MODIFIER>[^<]</MODIFIER>)"), ("ENTITY_pronoun",), ("FUNC_degreeHead",)),
    # <degreeHead + MODIFIER => DegreeP>
    ...
    (re.compile("<ACTION_verb>共</ACTION_verb>(?=<ENTITY_pronoun>)"), ("verb",), ("lightVerb",)),
    ...
    (re.compile("(?<=</ENTITY_classifier>)<ACTION_verb>結</ACTION_verb>"), ("ACTION_verb",), ("ENTITY_noun",)),
